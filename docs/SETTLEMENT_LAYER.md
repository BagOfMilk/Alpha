...
Передвісники:  Level 1 при Charge/Threshold ≥ 0.55
              Level 2 при ≥ 0.80
              Level 3 при ≥ 0.95
...
**Принцип чесності: «що і де — чесно, коли — ні.»** Передвісник рівня 2
...
| 700 | Pulse | накопичувачі, передвісники, відбір спрацьованих |
...
4. **Передвісник не бреше** — рівень 2 зобов'язаний назвати домен, рівень 3
...
|---|---|---|---|---|
| **Спокій** | крамниці відкриті допізна, діти у дворах, білизна на мотузках | «Добре, що ви тут» | побутовий бантер | немає |
...
| Розкол | своя мітка поверх їхнього графіті; бійка між своїми; **передвісник народження ворожого угруповання** |
...
| **Е1 «Інциденти і телеграфія»** | полоси наслідку + попередній перегляд порога, «незайнятий пост = Найгірший», `WorldPulse` (≥3 накопичувача), передвісники, 6–8 інцидентів у 2 тіри + 1 криза, ніч і патруль, доповідь із постів | L | криза відчувається заслуженою |
...
| `Crisis_NeverFiresWithoutLevel3Forewarn` | криза неможлива без передвісника 3 і grace-вікна |
...
| N6 | Криза відчувається несправедливою (спадкоємець R8) | 3 передвісники, grace-вікно, «що і де чесно, коли — ні», чутки як купована телеграфія | ПРИЙНЯТО + МОНІТОР |
