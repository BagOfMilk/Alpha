...
{
    /// <summary>
    /// G16 (GDD:98): «число підбирається контекстним атрибутом під підхід» —
    /// адаптер роками ігнорував другу половину формули і рахував лише
    /// голий скіл. Залякування → Воля (той самий атрибут, що й опір
    /// станам — AttributeType.Will), Переконання/Торгівля → Кмітливість.
    /// </summary>
