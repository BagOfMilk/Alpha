    ...
    public class CampaignPacingTests
    {
        ...
        public void Pacing_BandChangeCanBeMute_KnownGap()
        {
            ...
            Assert.AreEqual(0, mute,
                ...
                "слота не резервирует, поэтому в шумный день его в принципе может вытеснить бюджет) " +
                "не закрыт кодом, но в этом измеренном наборе кампаний (после G16/B7) ни разу не " +
                "воспроизвёлся — число честно обновлено, а не подогнано под ожидание");
        }
