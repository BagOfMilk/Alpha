...
{
    /// <summary>
    /// Погибший на посту (аудит разрывов, G17). Смерть очищала только сторону
    /// напарника, слот оставался занятым: мёртвый производил вечно, ел, а пост
    /// нельзя было отдать живому — хозяин считал его занятым.
    /// </summary>
    public class FallenOnPostTests
    {
        ...
        public void PostOfTheFallen_GoesToTheLiving()
        {
            ...
            // Сверка ещё не прошла — хозяин всё равно видит пост свободным.
