...
{
    /// <summary>
    /// Боевые состояния (GDD §3.1): набор из 7 + Шред как отдельная механика
    /// снижения брони (на юните копится счётчик шреда, не статус). Наложение
    /// гарантированное; Воля (Resolve) сокращает длительность, мин 1 ход.
    ///
