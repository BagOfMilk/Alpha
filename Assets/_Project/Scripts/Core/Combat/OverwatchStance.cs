...
{
    /// <summary>
    /// Взведённый overwatch (US-3.6) — чистые данные, без правил. Юнит заплатил
    /// AP за выстрел заранее и держит сектор: конус от своей клетки в сторону
    /// точки прицела. Когда и как он стреляет и когда дозор снимается, решает
    /// CombatState.
    /// </summary>
