...
namespace Game.Core.Combat
{
    ...
    public static class Pathfinder
    {
        ...
        /// в том же порядке — путь детерминирован. Нужен дозору (US-3.6): overwatch
        /// обязан видеть сам путь, а не только точку прибытия, иначе враг «проходит
        /// сквозь» сектор незамеченным. Пусто, если dest недостижим.
        /// </summary>
