...
namespace Game.Core.Combat
{
    ...
    public static class LineOfSight
    {
        public static bool HasLine(GridMap map, GridPos from, GridPos to)
        {
            ...
            // Оба конца из проверки выпадают в любом случае — стартовый тайл не
            // тестируется (цикл начинается с шага), целевой возвращает true до
            // BlocksSight, — поэтому своп результат не меняет, только делает его
            // одинаковым в обе стороны.
