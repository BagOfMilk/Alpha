...
namespace Game.Core.Session
{
    ...
    /// повинен стояти «Розпал» (~доба 22-23) з драбиною передвісників у три
    /// ступені і вікном милосердя — інакше криза вдарила б німою (інваріант 4).
    /// Підсумкова ціль: Ропіт ~д15, Бродіння ~д20, Розпал ~д22-23, бунт ~д25 —
    ...
    /// Ропіт д15, Бродіння д21, Розпал д21-23, бунт д25 і д30; той самий
