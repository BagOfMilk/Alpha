...
{
    /// <summary>Тип связи двух напарников по ценностям (US-9.6).</summary>
    ...
    /// <summary>
    /// Лёгкий эмерджентный слой связей по ценностям (US-9.6): НЕ трекаемая NxN-матрица,
    /// а вычисление по уже готовым данным — тегам ценностей из трейтов
    /// (<see cref="Game.Core.Traits.Trait.ValueTags"/>). Общий тег сближает (+),
    /// противоположная пара ссорит (−); итог — Kinship/Neutral/Friction.
    /// </summary>
    ...
    /// <summary>Канонические ценности прототипа (ПЛЕЙСХОЛДЕР-флавор) + их противоположности.</summary>
