...
namespace Game.Core.Balance
{
    ...
    public sealed class CheckBalance
    {
        ...
        // ---- Цена кровавого пути (Поправка №1: «быстро и очень тяжело») ----

        /// <summary>
        /// Очки ранения исполнителю за кровавый разбор.
        /// ЯКОРЬ: десять очков — это примерно двое суток лазарета при среднем
        /// лекаре, то есть исполнитель выпадает из расстановки на пару дней.
        /// </summary>
        public double BloodyPathInjury = 10.0;

        /// <summary>Сколько суток община помнит кровь.</summary>
        public int FearDurationDays = 3;

        /// <summary>
        /// Пока община боится, Убеждение и Торговля дороже на столько.
        /// ЯКОРЬ: шаг равен штрафу за повтор — страх стоит ровно одного
        /// «лишнего» подхода к теме.
        /// </summary>
