...
namespace Game.Core.Balance
{
    ...
    ///
    /// ЯКІР: Готовність — це «скільки громада встигла підготуватись», і росте
    ...
    ///
    /// СПОЖИВАЧ: <see cref="ReadinessBand"/> зсуває пороги фіналу
    ...
    public sealed class ReadinessBalance
    {
        ...
        /// ПЛЕЙСХОЛДЕРИ, як і решта чисел тестової збірки.
        /// </summary>
