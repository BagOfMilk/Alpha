...
namespace Game.Editor
{
    ...
    public static class UrpSetup
    {
        ...
        public static void Apply()
        {
            ...
            // Линейное цветовое пространство — не вкусовщина, а требование URP:
            // в гамме его формулы освещения считают неверно, и сцена уходит в
            // перенасыщенную бирюзу (проверено снимком 23.09.2026). Переключение
            // заставляет редактор переимпортировать текстуры и шейдеры — это
            // долго один раз и бесплатно потом.
